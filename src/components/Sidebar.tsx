  ...
  return (
    <>
          ...
          <div className="border-t border-gray-200">
            ...
            {userEmail && (
              <button
                ...
                className={`
                  w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all
                  ${isCollapsed ? 'justify-center' : ''}
                `}
      ...
      {showChangePassword && userEmail && (
        <ChangePasswordModal email={userEmail} onClose={() => setShowChangePassword(false)} />
      )}
    </>
  );
};
